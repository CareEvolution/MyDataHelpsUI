let strings: { [key: string]: string } = {
    ...
    "connect-oura-intro": "Sie können Daten von Ihrem Oura-Konto teilen, wenn Sie eins haben. Klicken Sie unten, um sich mit Ihren Oura-Anmeldeinformationen anzumelden.",
    "connect-oura-button": "Oura verbinden",
    "received-oura-data": "Wir erhalten Ihre Oura-Daten!",
    ...
    "asthma-control-status-header-complete-daily-entry": "Führen Sie Ihren täglichen Eintrag durch.",
    "asthma-control-status-header-multiple-out-of-range": "Mehrere Datenpunkte liegen |||außerhalb Ihrer normalen Werte|||.",
    "asthma-control-status-header-abnormal-heart-rate": "Ihre Ruheherzfrequenz liegt |||über Ihrem normalen Wert|||.",
    "asthma-control-status-header-abnormal-respiratory-rate": "Ihre Atemfrequenz liegt |||über Ihrem normalen Wert|||.",
    "asthma-control-status-header-abnormal-steps": "Ihre Aktivität liegt |||unter Ihrem normalen Wert|||.",
    "asthma-control-status-header-abnormal-sleep": "Ihre Schlafstörungen liegen |||über Ihrem normalen Wert|||.",
    "asthma-control-status-header-abnormal-blood-oxygen": "Ihr Blutsauerstoffgehalt liegt |||unter Ihrem normalen Wert|||.",
    "asthma-control-status-header-abnormal-home-aqi": "Ihr Luftqualitätsindex zu Hause liegt |||{aqi}|||.",
    "asthma-control-status-header-abnormal-work-aqi": "Ihr Luftqualitätsindex bei der Arbeit liegt |||{aqi}|||.",
    ...
    "asthma-control-status-header-controlled": "Basierend auf Ihren Einträgen ist Ihr Asthma |||unter Kontrolle|||.",
    "asthma-control-status-header-controlled-caregiver": "Basierend auf den Einträgen ist {name}s Asthma |||unter Kontrolle|||.",
    "asthma-control-status-header-not-controlled": "Basierend auf Ihren Einträgen ist Ihr Asthma |||nicht unter Kontrolle|||.",
    "asthma-control-status-header-not-controlled-caregiver": "Basierend auf den Einträgen ist {name}s Asthma |||nicht unter Kontrolle|||.",
    ...
    "asthma-log-entry-details-component-no-data": "Keine {dataType} protokolliert",
