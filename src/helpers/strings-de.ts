let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Ihre elektronischen Gesundheitsdaten sind eine wichtige Informationsquelle. Sie könnten Forschern helfen, neue Entdeckungen zu machen. Verbinden Sie Ihren Anbieter oder Ihre Krankenversicherung (z. B. Medicare) mit @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Vielen Dank, dass Sie Ihre EHR-Daten mit @@PROJECT_NAME@@ geteilt haben. Verbinden Sie einen weiteren Anbieter, um mehr Daten zu teilen, oder verwalten Sie Ihre EHR-Verbindungen.",
    "connect-ehr-text-generic": "Verbinden Sie Ihren Anbieter oder Ihre Krankenkasse, um Ihre Laborergebnisse, Erkrankungen, Medikamente und mehr anzuzeigen.",
    "connect-ehr-text-connected-generic": "Verbinden Sie einen weiteren Anbieter, um mehr Daten zu teilen oder Ihre EHR-Verbindungen zu verwalten.",
