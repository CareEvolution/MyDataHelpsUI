let strings: { [key: string]: string } = {
    ...
    "asthma-control-status-header-multiple-out-of-range-p1": "Mai multe puncte de date sunt ",
    "asthma-control-status-header-multiple-out-of-range-p2": "în afara nivelurilor normale",
    "asthma-control-status-header-multiple-out-of-range-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-heart-rate-p1": "Ritmul tău cardiac în repaus este ",
    "asthma-control-status-header-abnormal-heart-rate-p2": "peste nivelul normal",
    "asthma-control-status-header-abnormal-heart-rate-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-respiratory-rate-p1": "Rata ta respiratorie este ",
    "asthma-control-status-header-abnormal-respiratory-rate-p2": "peste nivelul normal",
    "asthma-control-status-header-abnormal-respiratory-rate-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-steps-p1": "Activitatea ta este ",
    "asthma-control-status-header-abnormal-steps-p2": "sub nivelurile normale",
    "asthma-control-status-header-abnormal-steps-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-sleep-p1": "Perturbările tale de somn sunt ",
    "asthma-control-status-header-abnormal-sleep-p2": "peste nivelul normal",
    "asthma-control-status-header-abnormal-sleep-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-blood-oxygen-p1": "Nivelul tău de oxigen din sânge este ",
    "asthma-control-status-header-abnormal-blood-oxygen-p2": "sub nivelul normal",
    "asthma-control-status-header-abnormal-blood-oxygen-p3": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-home-aqi-p1": "Indicele de calitate a aerului din casa ta este ",
    "asthma-control-status-header-abnormal-home-aqi-p2": ". Completează înregistrarea zilnică.",
    "asthma-control-status-header-abnormal-work-aqi-p1": "Indicele de calitate a aerului de la locul tău de muncă este ",
    "asthma-control-status-header-abnormal-work-aqi-p2": ". Completează înregistrarea zilnică.",
    ...
    "asthma-control-status-header-controlled-p1": "Pe baza înregistrărilor tale, astmul tău este ",
    "asthma-control-status-header-controlled-p1-caregiver": "Pe baza înregistrărilor, astmul lui {name} este ",
    "asthma-control-status-header-controlled-p2": "sub control.",
    "asthma-control-status-header-not-controlled-p1": "Pe baza înregistrărilor tale, astmul tău nu este ",
    "asthma-control-status-header-not-controlled-p1-caregiver": "Pe baza înregistrărilor, astmul lui {name} nu este ",
    "asthma-control-status-header-not-controlled-p2": "sub control.",
    ...
    "asthma-log-entry-details-component-no-data-p1": "Niciun ",
    "asthma-log-entry-details-component-no-data-p2": " înregistrat",
