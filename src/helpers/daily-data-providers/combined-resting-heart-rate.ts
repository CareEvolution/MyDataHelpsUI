...
import { combineResultsUsingAverageValue } from "./daily-data";
...
export default async function (startDate: Date, endDate: Date): Promise<DailyDataQueryResult> {
    ...
    return providers.length ? combineResultsUsingAverageValue(startDate, endDate, await Promise.all(providers)) : {};
}
