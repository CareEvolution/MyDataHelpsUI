...
describe("NumericCalculationTests", () => {
    test('QuestionIdentifier has .', () => {
      ...
      )).toBe(`Calculation Error - QuestionIdentifier "Q1.2" cannot have a "."`);
    });
    ...
    test('Checkbox - multiselect', () => {
      ...
      )).toBe('Calculation Error - Calculation not available for multiple-select text choice questions (Q1)');
    });
