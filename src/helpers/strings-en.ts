let strings: { [key: string]: string } = {
	"back": "Back",
	"close": "Close",
	"connect-ehr-title": "Connect Provider or Health Plan",
	...
	"external-accounts-title": "Providers / Health Plans / Devices",
	"external-accounts-title-without-devices": "Providers / Health Plans",
	...
	"device-data-no-data": "If you have connected Apple Health, Google Fit, or Fitbit, check back later to view your data.",
