let strings: { [key: string]: string } = {
    ...
    "received-oura-data": "We are receiving your Oura data!",
    ...
    "asthma-control-status-header-complete-daily-entry": "Complete your daily entry.",
    "asthma-control-status-header-multiple-out-of-range": "Multiple data points are |||outside your normal levels|||.",
    "asthma-control-status-header-abnormal-heart-rate": "Your resting heart rate is |||above your normal level|||.",
    "asthma-control-status-header-abnormal-respiratory-rate": "Your respiratory rate is |||above your normal level|||.",
    "asthma-control-status-header-abnormal-steps": "Your activity is |||below your normal levels|||.",
    "asthma-control-status-header-abnormal-sleep": "Your sleep disturbances are |||above your normal level|||.",
    "asthma-control-status-header-abnormal-blood-oxygen": "Your blood oxygen level is |||below your normal level|||.",
    "asthma-control-status-header-abnormal-home-aqi": "Your home Air Quality Index is |||{aqi}|||.",
    "asthma-control-status-header-abnormal-work-aqi": "Your work Air Quality Index is |||{aqi}|||.",
    ...
    "asthma-control-status-header-controlled": "Based on your entries, your asthma is |||under control|||.",
    "asthma-control-status-header-controlled-caregiver": "Based on the entries, {name}'s asthma is |||under control|||.",
    "asthma-control-status-header-not-controlled": "Based on your entries, your asthma is |||not under control|||.",
    "asthma-control-status-header-not-controlled-caregiver": "Based on the entries, {name}'s asthma is |||not under control|||.",
    ...
    "asthma-log-entry-details-component-no-data": "No {dataType} logged",
