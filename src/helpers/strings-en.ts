let strings: { [key: string]: string } = {
    ...
    "asthma-trigger-smoke": "Smoke (tobacco or wood burning)",
    ...
    "asthma-trigger-nsaid": "Taken a NSAID (non-steroidal anti-inflammatory drugs including aspirin and ibuprofen)",
    "asthma-trigger-beta-blocker": "Taken a beta blocker",
    "asthma-trigger-heartburn": "Had heartburn",
    "asthma-trigger-red-wine": "Drank red wine",
    "asthma-trigger-new-foods": "Tried any new foods",
    "asthma-trigger-cooked-without-ventilation": "Cooked without a fan or open window",
    "asthma-trigger-pet-in-bed": "Had a pet sleep in your bed",
    "asthma-trigger-incense-or-candle": "Burned incense or a candle",
