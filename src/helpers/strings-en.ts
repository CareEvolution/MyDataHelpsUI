let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Your electronic health records are an important source of information. They could help researchers make new discoveries. Connect your provider or health plan (ex: Medicare) with @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Thank you for sharing your EHR data with @@PROJECT_NAME@@. Connect another provider to share more data or manage your EHR connections.",
    "connect-ehr-text-generic": "Connect your provider or health plan to view your lab results, conditions, medications and more.",
    "connect-ehr-text-connected-generic": "Connect another provider to share more data or manage your EHR connections.",
