// DEPRECATED. Frozen at pre-redesign values so downstream content that references
// --ce-* vars (e.g. ViewBuilder custom views) keeps rendering unchanged. New code uses
// the --mdhui-* tokens.
export const legacyCeColors = `
    /* BASE-COLORS */
