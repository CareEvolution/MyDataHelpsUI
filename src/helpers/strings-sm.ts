let strings: { [key: string]: string } = {
    ...
    "asthma-control-status-header-multiple-out-of-range-p1": "O fa'amatalaga e tele o lo'o ",
    "asthma-control-status-header-multiple-out-of-range-p2": "i fafo o ou tulaga masani",
    "asthma-control-status-header-multiple-out-of-range-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-heart-rate-p1": "O le malosi o le tata o lou fatu i le malologa o lo'o ",
    "asthma-control-status-header-abnormal-heart-rate-p2": "sili atu i lou tulaga masani",
    "asthma-control-status-header-abnormal-heart-rate-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-respiratory-rate-p1": "O le malosi o lou mānava o lo'o ",
    "asthma-control-status-header-abnormal-respiratory-rate-p2": "sili atu i lou tulaga masani",
    "asthma-control-status-header-abnormal-respiratory-rate-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-steps-p1": "O au gaoioiga o lo'o ",
    "asthma-control-status-header-abnormal-steps-p2": "lalo ifo o ou tulaga masani",
    "asthma-control-status-header-abnormal-steps-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-sleep-p1": "O fa'alavelave i lou moe o lo'o ",
    "asthma-control-status-header-abnormal-sleep-p2": "sili atu i lou tulaga masani",
    "asthma-control-status-header-abnormal-sleep-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-blood-oxygen-p1": "O le tulaga o le okesene i lou toto o lo'o ",
    "asthma-control-status-header-abnormal-blood-oxygen-p2": "lalo ifo o lou tulaga masani",
    "asthma-control-status-header-abnormal-blood-oxygen-p3": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-home-aqi-p1": "O le Fa'avasega o le Lelei o le Ea i lou fale o lo'o ",
    "asthma-control-status-header-abnormal-home-aqi-p2": ". Fa'atumu lau fa'amaumauga o le aso.",
    "asthma-control-status-header-abnormal-work-aqi-p1": "O le Fa'avasega o le Lelei o le Ea i lou galuega o lo'o ",
    "asthma-control-status-header-abnormal-work-aqi-p2": ". Fa'atumu lau fa'amaumauga o le aso.",
    ...
    "asthma-control-status-header-controlled-p1": "Fa'avae i au fa'amaumauga, o lou ma'i sela o lo'o ",
    "asthma-control-status-header-controlled-p1-caregiver": "Fa'avae i fa'amaumauga, o le ma'i sela a {name} o lo'o ",
    "asthma-control-status-header-controlled-p2": "i lalo o le pulea.",
    "asthma-control-status-header-not-controlled-p1": "Fa'avae i au fa'amaumauga, o lou ma'i sela o lo'o ",
    "asthma-control-status-header-not-controlled-p1-caregiver": "Fa'avae i fa'amaumauga, o le ma'i sela a {name} o lo'o ",
    "asthma-control-status-header-not-controlled-p2": "le o i lalo o le pulea.",
