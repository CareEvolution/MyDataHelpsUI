let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "I tuoi registri sanitari elettronici sono una fonte importante di informazioni. Potrebbero aiutare i ricercatori a fare nuove scoperte. Collega il tuo fornitore o piano sanitario (es: Medicare) con @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Grazie per aver condiviso i tuoi dati EHR con @@PROJECT_NAME@@. Collega un altro fornitore per condividere ulteriori dati o gestire le tue connessioni EHR.",
    "connect-ehr-text-generic": "Collega il tuo medico o il tuo piano sanitario per visualizzare i tuoi risultati di laboratorio, condizioni, farmaci e altro ancora.",
    "connect-ehr-text-connected-generic": "Collega un altro medico per condividere più dati o gestire le tue connessioni EHR.",
