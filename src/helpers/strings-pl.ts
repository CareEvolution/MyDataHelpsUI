let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Twoje elektroniczne karty zdrowia są ważnym źródłem informacji. Mogą one pomóc badaczom w dokonywaniu nowych odkryć. Połącz swojego dostawcę lub plan zdrowotny (np. Medicare) z @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Dziękujemy za udostępnienie danych EHR z @@PROJECT_NAME@@. Połącz inny dostawcę, aby udostępnić więcej danych lub zarządzać połączeniami EHR.",
    "connect-ehr-text-generic": "Połącz się z dostawcą usług medycznych lub planem zdrowotnym, aby wyświetlić wyniki badań, schorzenia, leki i inne dane.",
    "connect-ehr-text-connected-generic": "Połącz się z innym dostawcą, aby udostępnić więcej danych lub zarządzać swoimi połączeniami EHR.",
