let strings: { [key: string]: string } = {
    ...
    "connect-oura-intro": "Możesz udostępniać dane ze swojego konta Oura, jeśli je posiadasz. Aby rozpocząć, kliknij poniżej, aby się zalogować za pomocą swoich danych do Oura.",
    "connect-oura-button": "Połącz Oura",
    "received-oura-data": "Otrzymujemy twoje dane z Oura!",
    ...
    "asthma-control-status-header-complete-daily-entry": "Uzupełnij swój dzienny wpis.",
    "asthma-control-status-header-multiple-out-of-range": "Wiele punktów danych znajduje się |||poza twoim normalnym poziomem|||.",
    "asthma-control-status-header-abnormal-heart-rate": "Twoje tętno spoczynkowe wynosi |||powyżej twojego normalnego poziomu|||.",
    "asthma-control-status-header-abnormal-respiratory-rate": "Twój oddech jest |||ponad twoim normalnym poziomem|||.",
    "asthma-control-status-header-abnormal-steps": "Twoja aktywność jest |||poniżej twojego normalnego poziomu|||.",
    "asthma-control-status-header-abnormal-sleep": "Twój sen jest zaburzony |||powyżej twojego normalnego poziomu|||.",
    "asthma-control-status-header-abnormal-blood-oxygen": "Poziom tlenu we krwi jest |||poniżej twojego normalnego poziomu|||.",
    "asthma-control-status-header-abnormal-home-aqi": "Wskaźnik jakości powietrza w twoim domu wynosi |||{aqi}|||.",
    "asthma-control-status-header-abnormal-work-aqi": "Wskaźnik jakości powietrza w twoim miejscu pracy wynosi |||{aqi}|||.",
    ...
    "asthma-control-status-header-controlled": "Na podstawie twoich wpisów twoja astma jest |||pod kontrolą|||.",
    "asthma-control-status-header-controlled-caregiver": "Na podstawie wpisów, astma u {name} jest |||pod kontrolą|||.",
    "asthma-control-status-header-not-controlled": "Na podstawie twoich wpisów twoja astma jest |||poza kontrolą|||.",
    "asthma-control-status-header-not-controlled-caregiver": "Na podstawie wpisów, astma u {name} jest |||poza kontrolą|||.",
    ...
    "asthma-log-entry-details-component-no-data": "Brak {dataType} zarejestrowanych",
