let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text": "Connectez votre prestataire ou votre mutuelle pour consulter vos résultats d'analyses, vos conditions, vos médicaments et plus encore.",
    "connect-ehr-text-connected": "Connectez un autre prestataire pour partager plus de données ou gérer vos connexions EHR.",
    ...
    "connect-oura-intro": "Vous pouvez partager des données de votre compte Oura si vous en avez un. Pour commencer, cliquez ou appuyez ci-dessous pour vous connecter avec vos identifiants Oura.",
    ...
    "completed": "Terminé",
    "ehr-intro-search": "Recherchez en entrant le nom de votre prestataire ou du portail des membres de votre prestataire de soins de santé ou de votre mutuelle.",
    ...
    "asthma-control-status-header-complete-daily-entry": "Terminez votre entrée quotidienne.",
    ...
    "asthma-control-status-header-abnormal-blood-oxygen": "Votre taux d'oxygène dans le sang est |||en dessous de votre niveau normal|||.",
    "asthma-control-status-header-abnormal-home-aqi": "Votre indice de qualité de l'air à domicile est |||{aqi}|||.",
    "asthma-control-status-header-abnormal-work-aqi": "Votre indice de qualité de l'air au travail est |||{aqi}|||.",
    ...
    "asthma-control-status-header-controlled-caregiver": "D'après les entrées, l'asthme de {name} est |||sous contrôle|||.",
    "asthma-control-status-header-not-controlled": "Selon vos entrées, votre asthme n'est pas |||sous contrôle|||.",
    "asthma-control-status-header-not-controlled-caregiver": "D'après les entrées, l'asthme de {name} est |||sous contrôle|||.",
    ...
    "asthma-log-entry-details-component-no-data": "Aucun(e) {dataType} enregistré(e)",
