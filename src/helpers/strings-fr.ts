let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Vos dossiers médicaux électroniques sont une source d'information importante. Ils pourraient aider les chercheurs à faire de nouvelles découvertes. Connectez votre fournisseur ou votre plan de santé (par exemple, Medicare) avec @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Merci d'avoir partagé vos données EHR avec @@PROJECT_NAME@@. Connectez un autre fournisseur pour partager plus de données ou gérez vos connexions EHR.",
    "connect-ehr-text-generic": "Connectez votre prestataire ou votre mutuelle pour consulter vos résultats d'analyses, vos conditions, vos médicaments et plus encore.",
    "connect-ehr-text-connected-generic": "Connectez un autre prestataire pour partager plus de données ou gérer vos connexions EHR.",
    ...
    "ehr-intro-research": "Vos dossiers médicaux électroniques (EHR) sont une source d'information importante. Si vous nous aidez à rassembler vos EHR, les chercheurs utiliseront ces données pour faire des découvertes.",
    "ehr-intro-generic": "Connectez votre prestataire ou votre mutuelle pour consulter vos résultats d'analyses, vos conditions, vos médicaments et plus encore.",
