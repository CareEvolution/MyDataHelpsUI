let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Sus registros electrónicos de salud son una fuente de información importante. Con ellos, usted podría ayudar a los investigadores de la salud a realizar nuevos descubrimientos. Conecte a su proveedor o a su plan de salud (por ejemplo: Medicare) con @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Gracias por compartir tus datos de EHR con @@PROJECT_NAME@@. Conecta a otro proveedor para compartir más datos o administrar tus conexiones de EHR.",
    "connect-ehr-text-generic": "Conecta tu proveedor o plan de salud para ver tus resultados de laboratorio, condiciones, medicamentos y más.",
    "connect-ehr-text-connected-generic": "Conecta otro proveedor para compartir más datos o gestionar tus conexiones EHR.",
