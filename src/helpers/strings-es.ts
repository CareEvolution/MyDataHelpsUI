let strings: { [key: string]: string } = {
	"back": "Atrás",
	"close": "Cerrar",
	"connect-ehr-title": "Conectar proveedor o plan de salud",
	...
	"external-accounts-title": "Proveedores / planes de salud / dispositivos",
	"external-accounts-title-without-devices": "Proveedores / planes de salud",
