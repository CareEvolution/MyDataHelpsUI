let strings: { [key: string]: string } = {
    ...
    "web-apple-health": "Si tiene un iPhone compatible, descargar la aplicación MyDataHelps iOS le permitirá compartir datos a través de Apple Health.",
    ...
    "apple-health-start-sharing": "Pulse a continuación para empezar a compartir sus datos de Apple Health.",
    "apple-health-share": "Compartir datos de Apple Health",
    "web-google-fit": "Si tiene un teléfono Android compatible, descargar la aplicación MyDataHelps Android le permitirá compartir datos a través de Google Fit.",
