let strings: { [key: string]: string } = {
    ...
    "connect-ehr-text-research": "Seus registros eletrônicos de saúde são uma fonte importante de informações. Eles podem ajudar os pesquisadores a fazer novas descobertas. Conecte seu provedor ou plano de saúde (ex: Medicare) com @@PROJECT_NAME@@.",
    "connect-ehr-text-connected-research": "Obrigado por compartilhar seus dados do EHR com @@PROJECT_NAME@@. Conecte outro provedor para compartilhar mais dados ou gerencie suas conexões do EHR.",
    "connect-ehr-text-generic": "Conecte seu provedor ou plano de saúde para visualizar seus resultados de exames, condições, medicamentos e muito mais.",
    "connect-ehr-text-connected-generic": "Conecte outro provedor para compartilhar mais dados ou gerenciar suas conexões de EHR.",
    ...
    "ehr-intro-research": "Seus registros eletrônicos de saúde (EHR) são uma fonte importante de informações. Se você nos ajudar a reunir seu EHR, os pesquisadores usarão esses dados para fazer descobertas.",
    "ehr-intro-generic": "Conecte seu provedor ou plano de saúde para visualizar seus resultados de exames, condições, medicamentos e muito mais.",
