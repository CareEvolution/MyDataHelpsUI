let strings: { [key: string]: string } = {
    ...
    "asthma-control-status-header-complete-daily-entry": "Complete sua inserção diária.",
    "asthma-control-status-header-multiple-out-of-range": "Múltiplos pontos de dados estão |||fora dos seus níveis normais|||.",
    "asthma-control-status-header-abnormal-heart-rate": "Sua frequência cardíaca de repouso está |||acima do seu nível normal|||.",
    "asthma-control-status-header-abnormal-respiratory-rate": "Sua frequência respiratória está |||acima do seu nível normal|||.",
    "asthma-control-status-header-abnormal-steps": "Sua atividade está |||abaixo dos seus níveis normais|||.",
    "asthma-control-status-header-abnormal-sleep": "Suas perturbações do sono estão |||acima do seu nível normal|||.",
    "asthma-control-status-header-abnormal-blood-oxygen": "Seu nível de oxigênio no sangue está |||abaixo do seu nível normal|||.",
    "asthma-control-status-header-abnormal-home-aqi": "O Índice de Qualidade do Ar em sua casa é |||{aqi}|||.",
    ...
    "asthma-control-status-header-controlled": "Com base nas suas inserções, sua asma está |||sob controle|||.",
    "asthma-control-status-header-controlled-caregiver": "Com base nas entradas, a asma de {name} está |||sob controle|||.",
    "asthma-control-status-header-not-controlled": "Com base nas suas inserções, sua asma está |||não está sob controle|||.",
    "asthma-control-status-header-not-controlled-caregiver": "Com base nas entradas, a asma de {name} está |||não está sob controle|||.",
    ...
    "asthma-log-entry-details-component-no-data": "Nenhum {dataType} registrado",
