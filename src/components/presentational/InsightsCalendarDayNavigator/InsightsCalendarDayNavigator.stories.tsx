...
import { CalendarDayState, CalendarDayStates, DateRangeCoordinator, DateRangeTitle, InsightsBadgeConfiguration, InsightsRenderingCoordinator, InsightsStateCoordinator, Layout } from '../index';
...
import InsightsCalendarDayNavigator from './InsightsCalendarDayNavigator';

type InsightsCalendarDayNavigatorStoryArgs = React.ComponentProps<typeof InsightsCalendarDayNavigator> & {
...
export default {
    title: 'Presentational/InsightsCalendarDayNavigator',
    component: InsightsCalendarDayNavigator,
    parameters: {
        layout: 'fullscreen'
    },
    render: (args: InsightsCalendarDayNavigatorStoryArgs) => {
        ...
        const navigator = <InsightsCalendarDayNavigator showLegend={args.showLegend}>
            <DateRangeTitle defaultMargin />
        </InsightsCalendarDayNavigator>;
        ...
        return <Layout colorScheme={args.colorScheme}>
            <DateRangeCoordinator variant="rounded" intervalType={args.intervalType} weekStartsOn="6DaysAgo">
                <InsightsDataCoordinator previewState={args.previewState} logSurveyName="Log Survey">
                    ...
                    >
                        {wrapWithRenderingCoordinatorIfNecessary(navigator)}
                    </InsightsStateCoordinator>
...
export const Default: StoryObj<InsightsCalendarDayNavigatorStoryArgs> = {
    args: {
        colorScheme: 'auto',
        intervalType: 'Month',
        previewState: 'loaded',
