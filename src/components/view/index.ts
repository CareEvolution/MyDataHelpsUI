...
export { default as MealAnalysisView } from "./MealAnalysisView"
...
export { default as NewPointsView, NewPointsViewProps, NewPointsEntry, showNewPoints, loadNewPoints } from "./NewPointsView"
