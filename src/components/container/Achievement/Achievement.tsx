...
import { AchievementPreviewState, createPreviewValueProvider } from './Achievement.previewData';
    ...
    return <div className="mdhui-achievement" ref={props.innerRef}>
        <div className="mdhui-achievement-chart">
            ...
            <div className="mdhui-achievement-chart-icon-wrapper">
                {<FontAwesomeIcon icon={props.icon ?? faStar} className="mdhui-achievement-chart-icon" style={{ color: statusColor }} />}
            </div>
        </div>
        <div className="mdhui-achievement-info">
            {loading &&
                <div className="mdhui-achievement-ratio-loading">
                    <FontAwesomeSvgIcon icon={faArrowsRotate} spin style={{ color: notStartedColor }} />
                </div>
            }
            {!loading &&
                <div className="mdhui-achievement-ratio" style={{ color: statusColor }}>{value + '/' + props.maxValue}</div>
            }
