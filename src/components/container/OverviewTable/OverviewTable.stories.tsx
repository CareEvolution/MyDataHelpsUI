...
const dataTypes: Record<OverviewDataTypeName, OverviewDataType> = {
    ...
    'mindful': createMindfulDataType(),
    'therapy': createTherapyDataType()
};
...
function createMindfulDataType(): PrimaryOverviewDataType | SecondaryOverviewDataType {
    return {
...
function createTherapyDataType(): PrimaryOverviewDataType | SecondaryOverviewDataType {
    return {
