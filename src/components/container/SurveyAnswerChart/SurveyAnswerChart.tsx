...
import { getDefaultPreviewData } from './SurveyAnswerChart.previewdata'
    ...
    const initialize = async (): Promise<void> => {
        ...
        if (props.previewDataProvider || props.previewState) {
            ...
            const previewDataProvider = props.previewDataProvider
                ? props.previewDataProvider(previewStartDate, previewEndDate)
                : getDefaultPreviewData(previewStartDate, previewEndDate, props.series.length, props.expectedDataInterval ?? { days: 1 });
