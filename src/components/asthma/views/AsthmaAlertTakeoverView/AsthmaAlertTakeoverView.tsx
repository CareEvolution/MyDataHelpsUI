...
export default function (props: AsthmaActivityViewProps) {
    ...
    return <Layout colorScheme={props.colorScheme ?? 'auto'} bodyBackgroundColor={backgroundColor}>
        ...
        <AsthmaAlertTakeoverNotice previewState={props.previewState} message="Multiple data points are outside your normal levels." logEntrySurveyName={props.logEntrySurveyName}/>
    </Layout>;
}
