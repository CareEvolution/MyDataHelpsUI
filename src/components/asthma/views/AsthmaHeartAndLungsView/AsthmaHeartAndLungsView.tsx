    ...
    return <Layout colorScheme={props.colorScheme ?? 'auto'}>
        <Section backgroundColor="#fff" noTopMargin={true}>
            ...
            {props.alert === 'DaytimeRestingHeartRate' &&
                <AsthmaAlertTakeoverNotice message="Your daytime resting heart rate is above your normal level." logEntrySurveyName={props.logEntrySurveyName}/>
            }
            {props.alert === 'NighttimeRestingHeartRate' &&
                <AsthmaAlertTakeoverNotice message="Your nighttime resting heart rate is above your normal level." logEntrySurveyName={props.logEntrySurveyName}/>
            }
            {props.alert === 'RespiratoryRate' &&
                <AsthmaAlertTakeoverNotice message="Your respiratory rate is above your normal level." logEntrySurveyName={props.logEntrySurveyName}/>
            }
            {props.alert === 'DaytimeBloodOxygenLevel' &&
                <AsthmaAlertTakeoverNotice message="Your daytime blood oxygen is below your normal level." logEntrySurveyName={props.logEntrySurveyName}/>
            }
            {props.alert === 'NighttimeBloodOxygenLevel' &&
                <AsthmaAlertTakeoverNotice message="Your nighttime blood oxygen is below your normal level." logEntrySurveyName={props.logEntrySurveyName}/>
            }
        </Section>
    </Layout>;
}
