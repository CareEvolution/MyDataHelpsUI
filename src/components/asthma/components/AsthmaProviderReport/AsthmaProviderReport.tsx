...
export default function (props: AsthmaProviderReportProps) {
    ...
    const openPdf = (deviceInfo: DeviceInfo) => {
        ...
        let pdfUrl = MyDataHelps.baseUrl + "WebVisualization/WebVisualizationPDF?patientID=" + participant!.getId() + "&modelType=VisualizationModel&visualizationKey=Shared.HtmlToPdf&noMargins=true&fileName=" + encodeURIComponent(fileName);
