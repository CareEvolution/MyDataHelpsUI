...
.env
-----
# Replace this example token with your actual participant access token
# Optional - Add PARTICIPANT_ENVIRONMENT_API to set where the token should be authenticated. 
# If not set, the default is "https://mydatahelps.org/"
PARTICIPANT_ACCESS_TOKEN=your_actual_token_here
```
