...
describe('Daily Data Provider - Google Health', () => {
    ...
    it('Distance: converts the millimeter daily rollup to meters.', async () => {
        setupDailyDataV2('GoogleHealth' as any, 'distance-daily', sampleStartDate, sampleEndDate, startDateFunctionEvaluator, sampleDailyDataV2);
    ...
    it('Sedentary: converts the seconds daily rollup to minutes.', async () => {
        setupDailyDataV2('GoogleHealth' as any, 'sedentaryPeriod-daily', sampleStartDate, sampleEndDate, startDateFunctionEvaluator, sampleDailyDataV2);
