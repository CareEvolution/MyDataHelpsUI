...
import { deepSleepMinutes, lightSleepMinutes, remSleepMinutes, totalSleepMinutes } from '../../../src/helpers/daily-data-providers/fitbit-sleep-v2';

describe('Daily Data Provider - Fitbit Sleep V2', () => {
    test.each([
        ...
        setupDailyDataPointsV2('Fitbit', 'sleep', sampleStartDate, sampleEndDate, undefined, undefined, dataPoints);
