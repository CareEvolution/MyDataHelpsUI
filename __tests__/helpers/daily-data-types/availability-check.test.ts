...
describe('Availability Check Tests', () => {
    ...
    describe('simpleAvailabilityCheck', () => {
        ...
        it('Should return false when querying is not enabled for the specified types.', async () => {
            ...
            expect(canQueryMock).toHaveBeenCalledWith(combinedDataCollectionSettings, namespace, [type1, type2], undefined);
    ...
    describe('combinedAvailabilityCheck', () => {
        ...
        it('Should return false when querying is not enabled for the specified types.', async () => {
            ...
            expect(canQueryMock).toHaveBeenNthCalledWith(1, combinedDataCollectionSettings, namespace1, [type1, type2], undefined);
            expect(canQueryMock).toHaveBeenNthCalledWith(2, combinedDataCollectionSettings, namespace2, [type3, type4], undefined);
            expect(hasV1DataMock).not.toHaveBeenCalled();
            expect(hasV2DataMock).not.toHaveBeenCalled();
        });
